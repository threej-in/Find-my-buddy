                                ...
                                <form method="post">            
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" id="txtotp" name="txtotp">
                                            </td>
                                            <td>
                                                <input class=" cursor-pointer w-full rounded-md py-1 bg-sky-600 text-white" type="submit" name="btnotpSubmit" id="btnotpSubmit" value="Submit otp">
                                            </td>
                                        </tr>
                                    </table>
                                </form>
